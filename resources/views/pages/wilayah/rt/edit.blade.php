...
<div class="container-fluid dashboard-body">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 dashboard-header">
            <i class="fas fa-edit"></i> Edit Data RT
        </h1>
    ...
    <div class="card shadow mb-4 dashboard-card">
        <div class="card-header py-3 dashboard-card-header">
            <h6 class="m-0 font-weight-bold">
                <i class="fas fa-map-marker-alt"></i> Form Edit RT
            </h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.rt.update', $rt->id) }}" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" 
                                   ...
                                   id="nama_ketua_rt" 
                                   name="nama_ketua_rt" 
                                   value="{{ old('nama_ketua_rt', $rt->nama_ketua_rt) }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" 
                                   ...
                                   id="kontak_rt" 
                                   name="kontak_rt" 
                                   value="{{ old('kontak_rt', $rt->kontak_rt) }}" 
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control dashboard-input @error('alamat_rt') is-invalid @enderror" 
                                      ...
                                      name="alamat_rt" 
                                      rows="3" 
                                      placeholder="Alamat lengkap RT">{{ old('alamat_rt', $rt->alamat_rt) }}</textarea>
                            @error('alamat_rt')
                                <div class="invalid-feedback d-block">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select class="form-control dashboard-input @error('status') is-invalid @enderror" 
                                ...
                                <option value="Aktif" {{ old('status', $rt->status) == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                <option value="Nonaktif" {{ old('status', $rt->status) == 'Nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback d-block">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                ...
                <div class="alert alert-info mt-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <small><strong>RW:</strong> RW {{ $rt->rw->nomor_rw }}</small><br>
                            <small><strong>Jumlah Warga:</strong> {{ $rt->wargas_count ?? 0 }}</small>
                        </div>
                        <div class="col-md-6">
                            <small><strong>Dibuat:</strong> {{ $rt->created_at->format('d/m/Y H:i') }}</small><br>
                            <small><strong>Diupdate:</strong> {{ $rt->updated_at->format('d/m/Y H:i') }}</small>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary dashboard-btn">
                                <i class="fas fa-save me-2"></i>Update RT
                            </button>
                        </div>
                    </div>
                </div>
